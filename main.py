...
X_test = utils.upload_data_to_train(f'data/{n_gram}_grams/X_test.csv', 'embedding')
X_val = utils.upload_data_to_train(f'data//{n_gram}_grams/X_val.csv', 'embedding')
...
df_embeddings.to_csv(f'assets/n_gram_embeddings/{n_gram}_grams/n_gram_embedding.tsv', sep='\t', index=False, header=False)
